<template>
    <div class="relative shadow-md rounded-3xl p-10 bg-white shade-component max-w-[100%] "
        ...
        <div class="relative flex justify-between mt-4 max-[768px]:flex-col gap-3 max-[768px]:mt-0">
            <button 
                @click="resetForm"
...
export default {
    ...
    methods: {
        ...
        async formSave() {
            ...
            await axios.post('/system/role/update/' + this.role.id, formData)
                .then((response) => {
